...
| `pytorch-imgcls_simple-cnn_digit-images_v1` | `pytorch/image-classification` | Not an LLM: a CNN over a folder of labelled images, the shape your own data is in |
